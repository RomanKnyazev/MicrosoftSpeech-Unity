...
namespace Assets
{
    public sealed class SpeechManager : MonoBehaviour
    {
        ...
        [SerializeField] private string SpeechServiceAPIKey = string.Empty;
        [Tooltip("Cognitive Services Speech Service Region.")]
        [SecretValue("SpeechService_Region")]
        [SerializeField] private string SpeechServiceRegion = string.Empty;

        [Tooltip("The audio source where speech will be played.")]
        [SerializeField] private AudioSource audioSource = null;

        [SerializeField] private VoiceName voiceName = VoiceName.enUSJessaRUS;
        [SerializeField] private int voicePitch = 0;
        ...
        public VoiceName VoiceName { get => voiceName; set => voiceName = value; }
        public int VoicePitch { get => voicePitch; set => voicePitch = value; }
